...
namespace ZOQ::Stm32_HAL {
	...
	public:
		hal_uart_dma(UART_HandleTypeDef* h, uint8_t* rxbuffer, size_t rxbuffer_size, uint8_t* txbuffer, size_t txbuffer_size);
	...
	inline hal_uart_dma::hal_uart_dma(UART_HandleTypeDef* h,
									  uint8_t* _rxbuffer,
									  size_t _rxbuffer_size,
									  uint8_t* _txbuffer,
									  size_t _txbuffer_size)
									: 	handle(h),
										rxbuffer(_rxbuffer),
										rxbuffer_size(_rxbuffer_size), read_ptr(_rxbuffer),
										txbuffer(_txbuffer), txbuffer_size(_txbuffer_size){
